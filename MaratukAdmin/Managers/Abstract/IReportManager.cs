...
namespace MaratukAdmin.Managers.Abstract
{
    public interface IReportManager
    {
        ...
        Task<List<ReportTotal>?> GetReportTotalAsync<T>(DateTime? dateFrom = null, DateTime? dateTo = null, enumBookStatusForMaratuk bookStatus = enumBookStatusForMaratuk.All) where T : class;
